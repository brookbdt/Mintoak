    ...
    <div className="h-fit w-100% bg-8FC055">
      ...
      <div className="relative top-bg-container">
        ...
        <div className="desktop:w-50% desktop:p-100 laptop:p-100 laptop:w-70% tablet:w-80% tablet:p-30 px-20 mobile:pt-350 pb-40 z-10">
          ...
          <div className="text-s24l150 mobile:text-s14l24 text-525252 shrink-0 mt-37">
            ...
            services, our comprehensive digital payment's platform helps bridge
            the gap between banks and small businesses.
          </div>
      ...
      <div className="flex items-center justify-around px-200 mb-150">
        ...
        <div className="text-center text-s36l43 text-252525">
          ...
          <div className="text-s20l24 text-525252 mt-10">
      ...
      {/* Mintoak Advantages */}
      <div className="flex justify-around text-252525 text-s44l120 mb-60">
        Mintoak Advantages
      </div>
      <div className="flex justify-around w-100% px-100 mb-150">
        <div className="flex flex-col items-center border border-8CC63E justify-center w-40% p-20 mx-20">
          ...
          <div className="font-bold text-s24l29 text-252525 mt-30 text-center">
            Cloud based toolkit
          </div>
      ...
      <div className="flex flex-col bg-footer mb-100 w-100%">
        <div className="flex w-100%">
          <div
            className={
              "flex items-center justify-center w-50% py-40 border-b cursor-pointer " +
          ...
          {isBORM === "b" ? (
            <>
              <div className=" flex flex-col w-50% justify-center">
                <div className="text-s24l29 text-F1F1F1 mb-80">
                  On your path to business growth, unlock new opportunities for
                  saving costs, generating new revenue streams and simplified
                  management with our comprehensive payments ecosystem that
                  enables acceptance across all modes with the benefit of
                  real-time tracking anytime, anywhere.
                </div>
                ...
                <div className="text-s20l150 text-8CC63E cursor-pointer">
                  Know More
                </div>
              ...
              <div className="w-50% flex items-center justify-center">
                <Image
                  src="/images/backgrounds/for_bank.svg"
                  height={650}
                  width={500}
                />
              </div>
            ...
            <>
              <div className=" flex flex-col w-50% justify-center">
                <div className="text-s24l29 text-F1F1F1 mb-80">
                  ...
                  one-stop ecosystem for conducting their myriad transactions
                  and managing, exploring, and expanding their business. This is
                  what we offer, with superior features of real-time tracking of
                ...
                <div className="text-s20l150 text-F1F1F1">
                  ...
                  management simpler and faster, our solutions help merchants
                  tackle all existing challenges with ease
                </div>
                <div className="text-s20l150 text-8CC63E cursor-pointer">
                  Learn More
                </div>
      ...
      <div className="text-s44l120 text-252525 mb-30 font-bold text-center">
        Building a global community
      </div>
      <div className="flex justify-center items-center w-100% py-50 px-150 mb-100">
        <Carousel
          itemsToShow={3}
      ...
      <div className="flex flex-col items-center bg-footer w-100% p-60">
        <div className="text-center font-bold text-FAFAFA text-s44l120 p-50">
          Our achievements
        </div>
        <div className="flex items-center w-100% py-50 px-100">
          <Carousel
            ...
            enableMouseSwipe={false}
            pagination={false}
            renderArrow={whiteCarouselArrows}
          >
            ...
            <div className="flex flex-col items-center bg-313131 w-90% p-40 border border-C4C4C4">
              ...
              <div className="text-DFDFDF text-center mt-12 text-s20l150">
                PCI DSS Level : 1 Classifcation : Merchant
              </div>
            </div>
          </Carousel>
        </div>
      ...
      <div className="w-100% flex-col justify-center items-center mt-100">
        <div className="text-center font-bold text-s44l66 text-252525 mb-60">
          In the media
        </div>
      ...
      <div className="px-180 py-150">
        <div className="border-2 border-b-0 border-8CC63E">
          <div className="mb-40 ml-40 mt-50">
            ...
            <div className="text-000000 text-s30l36 mb-48 mt-20">
