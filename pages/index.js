    ...
    <div className="h-fit w-100%">
      <div className="relative">
        ...
        <div className="desktop:w-50% desktop:p-100 laptop:p-100 laptop:w-70% tablet:w-80% tablet:p-30 px-20 mobile:pt-350 pb-40 z-10">
          <div className="text-s44l120 text-252525 shrink-0">A one-stop </div>
          <div className="text-s56l124_5 font-bold text-252525 shrink-0">merchant ecosystem</div>
          <div className="text-s44l120 text-252525 shrink-0">for all your business needs</div>
          <div className="text-s24l150 text-525252 shrink-0 mt-37">
