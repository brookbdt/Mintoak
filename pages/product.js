  ...
  return (
    <div className="desktop:h-fit laptop:h-fit w-100% bg-home-top mobile:w-100%">
      ...
      <div className="relative top-bg-container flex w-100% border-b border-A4D77A mobile:flex-col mobile:border-0">
        ...
        <div className="desktop:w-50% desktop:pb-88 laptop:pb-88 laptop:w-50%  pr-50 pt-175 laptop:pt-80 z-10 mobile:w-100% mobile:mt-70 mobile:p-20 ">
          ...
          <div className="pl-181 laptop:pl-100 mobile:pl-0 text-s56l67 mobile:text-s36l43 font-bold text-252525 w-100% desktop:pt-45 laptop:pt-45 mobile:pt-10">
            Mintoak {component == 'AIM' ? 'AIM' : component == 'PAM' ? 'PAM' : 'ACCORN'}
          </div>
      ...
      <><div className="w-100% relative desktop:px-100 mobile:hidden mobile:pb-35 bg-currunt flex mobile:flex-col desktop:h-850 overflow-hidden laptop:h-976">
                  ...
                  <div className="w-27 h-27 flex justify-center items-center">
                    <div
                      className={`${activeTab == 0
                          ? "w-22 h-21 bg-252525 "
                          : "w-14 h-14 bg-848484"} rounded-full bg-opacity-100 `}
                    ></div>
                  </div>
        ...
        </div><div className="laptop:hidden desktop:hidden p-20 mt-60">
                ...
                return (
                  <div className="flex">
                    {pages.map((page) => {
                      ...
                      return (
                        <div
                          className={`bg-C4C4C4 w-6 h-6 rounded-full mr-6 mb-40 ${isActivePage ? "bg-525252" : ""}`}
                          key={page}
      ...
      {/* PAM */}
      {
        ...
        <div className="w-50% flex flex-col desktop:pr-65 mobile:w-100% mobile:px-20">
          <div className="desktop:text-s44l57_2 desktop:text-252525 font-bold mobile:text-s22l33 mobile:pb-16">Real-Time Dashboard of Portfolio Trends</div>
          <div className="desktop:text-s20l30 desktop:text-525252 desktop:pt-32 mobile:text-s14l21 mobile:pb-40">
            Multiple Trends to Gauge Portfolio Performances across. From volume to value to split of transactions,
            derive insights from the wide spectrum of parameters before you.Interactive Dashboard helping Cluster Merchants <br /><br />
            Based on the domain and the trend you want to visualize, Mintoak PAM’s interactive dashboard
            helps you group merchants together for better comparison.
          </div>
        </div>
      ...
      </div><div className="w-100% flex desktop:flex-row-reverse items-center justify-around desktop:px-180 desktop:pt-150 mobile:flex-col mobile:pb-80">
          <div className="w-50% flex flex-col desktop:pl-65 mobile:w-100% mobile:px-20">
            <div className="desktop:text-s44l57_2 desktop:text-252525 font-bold mobile:text-s22l33 mobile:pb-16">Merchant activation trends across form factors</div>
            <div className="desktop:text-s20l30 desktop:text-525252 desktop:pt-32 mobile:text-s14l21 mobile:pb-40">
              Several Business Domains and Trends to Choose from.Create and compare your portfolio in your specific business domain with all latest trends, each with a vast number of options to look at.
        ...
        <div className="desktop:text-s44l57_2 desktop:text-252525 font-bold mobile:text-s22l33 mobile:pb-16 desktop:pr-120">Control and conquer transaction risks</div>
        ...
        Secure transaction processing with Mintoak ACORN’s on-device, in-transit, in-storage feature, you can rest assured of the security of your transactions. 
       </div>
       <div className="desktop:text-s44l57_2 desktop:text-252525 font-bold mobile:text-s22l33 mobile:pb-16 desktop:pr-70">Encryption and Tokenization Tools</div>
        ...
        Ensure complete compliance with PCI and DSS with ACORN’s smart tokenization and encryption tools. 
       </div>
       <div className="desktop:text-s44l57_2 desktop:text-252525 font-bold mobile:text-s22l33 mobile:pb-16 desktop:pr-120">Wide Variety of Transactions & Devices Supported</div>
        ...
        Helping businesses and merchants diversify with our widely compliant platform.
       </div>
        </div>
      ...
      <div className={` desktop:pt-81 laptop:pt-81 mobile:w-100% global-collapse mobile:px-20 desktop:px-180 ${component == 'PAM' ? "desktop:hidden laptop:hidden" : component == "ACCORN" ? "desktop:hidden laptop:hidden" : ""}`}>
