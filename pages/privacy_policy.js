    ...
    <div className="w-100% desktop:pl-180 desktop:pr-582 mobile:px-20 bg-home-top">
      ...
      <div>
        ...
        <div className="desktop:text-s24l36 mobile:text-s14l21 text-525252 desktop:pb-80 mobile:pb-40">
          ...
          server from the visitor’s browser or through the Mintoak
        ...
        <div className="w-100%">
          ...
          <div>
            ...
            <div className="desktop:text-s24l36 text-525252 mobile:text-s14l21 desktop:pb-40 mobile:pb-14">
              We may use information about you to provide, maintain, and improve
              our Services, such as:Processing or recording payment
              ...
              functions or activities of Mintoak, related to services in which
              the Concerned Person is interested, and/or to help determine the
              eligibility of the Concerned Persons for the product/services
              requested/ applied/ shown interest in and/or to enable Mintoak the
              Covered Persons verification and/or process applications,
            ...
            <div className="desktop:text-s24l36 text-525252 mobile:text-s14l21 desktop:pb-40 mobile:pb-14">
              ...
              unless the same is necessary to protect the interests of Mintoak
              or to enable Mintoak to provide you services or to enable the
              completion/compilation of a transaction, credit reporting, or the
              same is necessary or required pursuant to applicable Indian Laws
              or Statute or Government or Reserve Bank of India or any other
              regulatory bodies/organisations in India or pursuant to the terms
              and conditions applicable to such Information as agreed to with
              Mintoak or pursuant to any requirement of law/regulations or any
            ...
            <div className="desktop:text-s24l36 text-525252 mobile:text-s14l21 desktop:pb-40 mobile:pb-14">
              Information provided by you are retained (for later of the) (i) as
              long as the purposes for which such data were collected continue.
              Or (ii) for such period to satisfy legal, regulatory or accounting
              requirements or to protect Mintoak's interests.
            </div>
            <div className="desktop:text-s24l45 desktop:text-252525 mobile:text-s14l21 mobile:text-000000 desktop:pb-20 mobile:pb-8 font-semibold">
              Covered Persons obligations :
            </div>
            <div className="desktop:text-s24l36 text-525252 mobile:text-s14l21 desktop:pb-40 mobile:pb-14">
              Please note that the accuracy of the Information provided to us on
              the Website or on the Mintoak Platform , is essential, among
              others, to provision of our products and services to you. It is
              therefore a term and condition governing the access and use of the
              Website, Mintoak Services & Device, software platforms that you
              undertake to ensure the accuracy and completeness of all
              Information disclosed, shared, exchanged or otherwise update and
              notify Mintoak via e-mail at www.mintoak.com/services of any
              changes in the Information. The Covered Persons authorises Mintoak
              to exchange, share, part with all information related to the
              details and transaction history of the Covered Persons to its
              Affiliates / banks / financial institutions / credit bureaus /
              ...
              credit reporting, statistical analysis and credit scoring,
              verification or risk management or any of the aforesaid purposes
              and shall not hold Mintoak liable for use or disclosure of this
              information. The Covered Persons shall not disclose to any other
              person, in any manner whatsoever, any information relating to
              Mintoak or its Affiliates of a confidential nature obtained during
              availing the services through the website. Failure to comply with
              this obligation shall be deemed a serious breach of the terms
              herein and shall entitle Mintoak or its Affiliates to terminate
              the services, without prejudice to any damages, to which the
              Covered Persons may be entitled otherwise.
            </div>
            <div className="desktop:text-s24l45 desktop:text-252525 mobile:text-s14l21 mobile:text-000000 desktop:pb-20 mobile:pb-8 font-semibold">
              We may use cookies to :
            </div>
            <div className="desktop:text-s24l36 text-525252 mobile:text-s14l21 desktop:pb-40 mobile:pb-14">
              The Mintoak website may uses cookies. Cookies are small data files
              that a website stores on your computer. We use persistent cookies
              which are permanently placed on your computer to store
            ...
            <div className="desktop:text-s24l36 text-525252 mobile:text-s14l21 desktop:pb-40 mobile:pb-14">
              ...
              your identify before granting you access to your account. However,
              no method of transmission over internet, or method of electronic
              storage is 100% secure and so we cannot fully ensure or guarantee
              the security of any information you transmit to us or guarantee
              that information on our application may not be accessed,
              disclosed, altered, or destroyed by any person.
            </div>
            <div className="desktop:text-s24l45 desktop:text-252525 mobile:text-s14l21 mobile:text-000000 desktop:pb-20 mobile:pb-8 font-semibold">
              Amendments :
            </div>
            <div className="desktop:text-s24l36 text-525252 mobile:text-s14l21 desktop:pb-40 mobile:pb-14">
              Mintoak may, from time to time, amend or change this policy from
              time to time by posting a revised version on its Website
              https://www.mintoak.com and updating the “Last updated date”
              above. The revised version will be effective at the time we post
              it. We will provide you with reasonable prior notice of
              substantial changes in how we use your information, including by
              email at the email address you provide. Where these changes would
              cause material detriment to you, you may of course cancel your
              account at any time. We encourage you to review this Privacy
              Policy whenever you access or use in any manner Mintoak Services,
              Device, application, product, service, feature, technology,
              content, or website (collectively, “Services”) to stay informed
              about our information practices and the choices available to you
              and to contact us if you have any questions about these changes.
              Your continued use of our Services constitutes your acceptance of
              any amendment of this Privacy Policy.
            </div>
            <div className="desktop:text-s24l45 desktop:text-252525 mobile:text-s14l21 mobile:text-000000 desktop:pb-20 mobile:pb-8 font-semibold">
              Contact :
            </div>
            <div className="desktop:text-s24l36 text-525252 mobile:text-s14l21 desktop:pb-40 mobile:pb-14">
              You may contact us with any questions or concerns regarding this
