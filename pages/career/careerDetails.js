...
export default function CareerDetails() {
    ...
    const prefixSelector = (
        <Form.Item name="prefix" noStyle>
            <Select style={{ width: 70, height: 30 }} defaultValue="91" showArrow={false}>
        ...
        <div className="desktop:h-fit w-100% bg-8FC055 mobile:w-100%">
            ...
            <div className="flex items-center justify-between laptop:p-100 pt-100 mobile:pt-40 px-180 mobile:px-20">
                <div className="desktop:flex items-center justify-between w-100% ">
                    <div className="w-50% desktop:pr-14 mobile:w-100% mobile:py-20">
                        <div className="text-s32l45 font-semibold mobile:text-s22l44">Job description</div>
                        <ul className="pt-24 list-disc mobile:px-20">
                            <li className="text-s24l40_8 mobile:text-s14l23_28">Design overall architecture of the application.</li>
                            <li className="text-s24l40_8 mobile:text-s14l23_28">Work with UI designers</li>
                            <li className="text-s24l40_8 mobile:text-s14l23_28">API Integration, Database Management and code review</li>
                            <li className="text-s24l40_8 mobile:text-s14l23_28">Maintain quality and ensure responsiveness of applications</li>
                            <li className="text-s24l40_8 mobile:text-s14l23_28">Collaborate with the rest of the engineering team to design</li>
                            <li className="text-s24l40_8 mobile:text-s14l23_28">Maintain code integrity and organization</li>
                            <li className="text-s24l40_8 mobile:text-s14l23_28">OWASP security implementation</li>
                            <li className="text-s24l40_8 mobile:text-s14l23_28">Understand and implement security and data protection</li>
                        </ul>
                    </div>
            ...
            <div className="flex items-center justify-between laptop:p-100 desktop:pt-60 px-180 mobile:px-20">
                <div className="flex items-center justify-between w-100%">
                    <div className="w-50% desktop:pr-14 mobile:w-100% mobile:py-20">
                        <div className="text-s32l45 font-semibold mobile:text-s22l44">Qualifications</div>
                        <ul className="pt-24 list-disc mobile:px-20">
                            <li className="text-s24l40_8 mobile:text-s14l23_28">BTech, BE, MCA or higher</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <Form>
                            <Row gutter={24}>
                                ...
                                <Col xs={24} md={8}>
                                    ...
                                    >
                                        <label className="text-s20l24 text-C4C4C4">Contact Number</label>
                                        <Input addonBefore={prefixSelector} style={{ width: '100%' }} />
                                    </Form.Item>
                                </Col>
                                <Col xs={24} md={8}>
                                    <Form.Item>
                                        <label className="text-s20l24 text-C4C4C4">Key Skills</label>
                                        <Select placeholder="Select key skills">
                                            <Option style={{ width: '100%' }} value="Frontend Developer">Frontend Developer</Option>
                                        </Select>
                                    </Form.Item>
                                </Col>
                            </Row>
                            <Row gutter={24}>
                                <Col xs={24} md={8}>
                                    <Form.Item>
                                        <label className="text-s20l24 text-C4C4C4">Email Address</label>
                                ...
                                <Col xs={24} md={8}>
                                    <Form.Item>
                                        <label className="text-s20l24 text-C4C4C4">Qualifications</label>
                            ...
                            <div className="text-s20l24 text-C4C4C4 pt-48">Resume (.pdf, .doc, .docx upto 2mb)</div>
                            <div className="pt-58">
                                <Form.Item>
                                    <Upload>
            ...
            <div className="desktop:px-180 py-150 pt-0 mobile:py-80">
                <div className="text-center font-bold text-s44l45 pb-60 mobile:text-s22l44">View similar roles</div>
                ...
                <div className="text-s22l33 text-8DBF52 text-center cursor-pointer mobile:text-s14l21"><span className="border-b-2">View All</span></div>
            </div>
        </div>
    )
}
