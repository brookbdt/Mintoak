    ...
    return (
        <div>
                ...
                <div className="flex relative top-bg-container bg-bg_resource h-fit laptop:w-fit bg-origin-content">
                    ...
                    <div className="desktop:w-50% desktop:p-100 laptop:p-100 laptop:w-70% tablet:w-80% tablet:p-30 px-20 mobile:pt-40 pb-40 z-10">
                        <div className="text-s44l120 mobile:text-s20l24 text-FFFFFF shrink-0">
                            ...
                            24/7 — with instant transfer

                        </div>
                        <div className="text-s24l36 mobile:text-s14l24 mobile:text-center text-FFFFFF shrink-0 mt-37">
                            In the fourth season of the American sitcom Friends, Chandler wants to quit his gym membership...
                        </div>
                        <div >
                    ...
                    <div className="desktop:w-50% desktop:p-100 laptop:p-100 laptop:w-70% tablet:w-80% tablet:p-30 px-20 mobile:pt-40 pb-40 z-10 flex flex-col items-end">
                        <div className="cursor-pointer btn rounded-md">
                            <Image src="/images/backgrounds/resource-bg.svg" width={128} height={84} />
                        </div>
            ...
            <div className="bg-F3FBF5">
                <div className="pt-80 pl-182 text-s44l66 pb-60">
                    In the media
                </div>
                <div className="flex justify-center px-180 py-42 items-center">

                    <input className="h-54 w-100% bg-DFEFD4 text-s20l24" placeholder="Ex. Future of banking..." />
                ...
                <div className="px-180 flex pb-82 w-100% laptop:flex-wrap">
                    ...
                    <button className="text-s20l40 w-151 bank-btn rounded-xl mr-21 border py-10"><Image src="/images/icons/bank.svg" height={20} width={20} /><span className="pl-6">For Banks</span></button>
                    <button className="text-s20l40 w-189 bg-DFEFD4  rounded-xl border py-10 mr-21"><Image src="/images/icons/merchant.svg" height={20} width={20} /><span className="pl-6">For Merchant</span></button>
                    <button className="text-s20l40 w-151  bg-DFEFD4 rounded-xl border mr-21 py-10"><Image src="/images/icons/payment-bank.svg" height={20} width={20} /><span className="pl-6">Payments</span></button>
                    <button className="text-s20l40 w-193  bg-DFEFD4 rounded-xl border mr-21 py-10"><Image src="/images/icons/finance.svg" height={20} width={20} /><span className="pl-6">Finance Trends</span></button>
                    <button className="text-s20l40 w-151  bg-DFEFD4 rounded-xl border mr-21 py-10"><Image src="/images/icons/product.svg" height={20} width={20} /><span className="pl-6">Product</span></button>
                    <button className="text-s20l40 w-120  bg-DFEFD4 rounded-xl border mr-21 py-10"><Image src="/images/icons/fintech.svg" height={20} width={20} /><span className="pl-6">Fintech</span></button>
                    <button className="text-s20l40 w-195  bg-DFEFD4 rounded-xl border mr-21 py-10"><Image src="/images/icons/growth.svg" height={20} width={20} /><span className="pl-6">Growth Strategy</span></button>
                </div>
                ...
                <div className="mx-181 laptop:mx-100 bg-FFFFFF flex shadow-bankbox">
                    ...
                    <div className="pl-27 pt-53">
                        <div className="text-46AC34 text-s20l24 pb-24">
                            6 min read
                        </div>
