      ...
      <div className="w-100% desktop:px-180 laptop:px-100 mobile:px-20 bg-home-top">
        <div className="flex flex-col">
          ...
          <div className="flex pt-48 pb-40 mobile:hidden">
            ...
            <div className={`button w-206 text-s22l26_4 ${isClickedSearch && 'btn-click-shaddow'}`} onMouseUp={() => clicked()} onClick={() => { handleSearch(); }}>Search</div>
            <div
          ...
          <div className="flex pt-30 pb-40 desktop:hidden laptop:hidden">
            ...
            <div className={`${isClickedSearch && 'btn-click-shaddow'} button w-54 text-s22l26_4 mobile:text-s18l21_6 px-18`} onMouseUp={() => clicked()} onClick={() => { handleSearch(); }}>
