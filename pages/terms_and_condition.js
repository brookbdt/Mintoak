    ...
    <div className="w-100% desktop:px-180 desktop:pr-540 laptop:pl-100 laptop:pr-300 mobile:px-20 bg-home-top">
      <div className="w-100%">
        ...
        <div className="mobile:text-s14l21 desktop:text-s24l36 laptop:s18l22 text-525252 pb-50 desktop:pb-80 laptop:pb-80">
          ...
          Card and its swiping/dipping/tapping on the device. <br />
          <br />
      ...
      <div>
        ...
        <div className="desktop:text-s24l36 mobile:text-s14l21 text-525252 desktop:pb-150 mobile:pb-80">
          ...
          and Conditions. <br />
          <br />
          1.3 By clicking “I Accept” or “I Agree” on the signup page, where this
          option is made available in Mintoak’s online Merchant Boarding
          ...
          also available on our website https://www.mintoak.com <br />
          <br />
          ...
          reading carefully, the entire agreement and its clauses. <br />
          <br />
          {clickStatus == false ? (
            <>
              <div className="h-110 w-1249  bg-read_more absolute">
              ...
              <br />
              “Aadhaar Number” means 12-digit unique identification number
              issued to a resident Indian by the Unique Identification Authority
              of India (UIDAI). “Aadhaar based eSign” means a technology
              initiated by the Government of India. It allows citizens to sign
            </>
          ) : (
            <>
              any document remotely. Anyone with a valid Aadhaar number and a
              registered mobile number can use this service to sign documents
              from anywhere any time. Using this service, one can sign a
              document with any number of parties inviting them to place their
              eSign on the document to make the document legally valid and
              enforceable.
              <br />
              <br />
              ...
              Mintoak’s website https://www.mintoak.com and any changes /
              amendments to these Terms and conditions shall be updated on the
              website too.
              <br />
